This repository contains (i) hardware implementation (combining ANN+SNN), and (ii) related scripts for experiments (training, converting the model into the hardware-friendly format, etc). Refer to our Paper.

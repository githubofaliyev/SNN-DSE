`include "C:/Users/jlopezramos/Desktop/Vivado Projects/Models/LIF Experiments/DVSGesture/Stochastic Spike Operator (1.0)/DVSGesture T2 beta(0.60) thr(1.20) INT4 (50.00%)_{64_28_48_54_120_126_140_56_50}/macros.txt"
...
parameter CONV_1_1_INPUT_FRAME_WIDTH = `conv_1_1_input_frame_width;
...
parameter USER_SET_NEURON_TYPE = `neuron_type;
parameter beta = `beta;
...
/***************************************** CONV_1_1 layer ***********************************************/  
 ...
 generate
    ...
    conv_nc #(
        ...
        .BETA(beta),
        .signed_POSITIVE_THRESHOLD(threshold),
 ...
 CONV_1_1_spk_ram (
  ...
  logic [CONV_1_1_EC_SIZE:0] CONV_1_1_nc_iter, CONV_1_1_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_1_1_state)
            ...
            1:begin
                ...
                conv_1_1_ons += $countones(CONV_1_1_post_syn_spk[CONV_1_1_nc_iter]);
...
/*************************************** CONV_1_1 Spike R/W ********************************************/  
 ...
 CONV_1_2_spk_ram (
  ...
  logic [CONV_1_2_EC_SIZE:0] CONV_1_2_nc_iter, CONV_1_2_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_1_2_state)
            ...
            1:begin
                ...
                conv_1_2_ons += $countones(CONV_1_2_spk_bram_wrdat_nxt);
 ...
 CONV_2_1_spk_ram (
  ...
  logic [CONV_2_1_EC_SIZE:0] CONV_2_1_nc_iter, CONV_2_1_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_2_1_state)
            ...
            1:begin
                ...
                conv_2_1_ons += $countones(CONV_2_1_spk_bram_wrdat_nxt);
 ...
 CONV_2_2_spk_ram (
  ...
  logic [CONV_2_2_EC_SIZE:0] CONV_2_2_nc_iter, CONV_2_2_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_2_2_state)
            ...
            1:begin
                ...
                conv_2_2_ons += $countones(CONV_2_2_spk_bram_wrdat_nxt);
 ...
 CONV_3_1_spk_ram (
  ...
  logic [CONV_3_1_EC_SIZE:0] CONV_3_1_nc_iter, CONV_3_1_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_3_1_state)
            ...
            1:begin
                ...
                conv_3_1_ons += $countones(CONV_3_1_spk_bram_wrdat_nxt);
 ...
 CONV_3_2_spk_ram (
  ...
  logic [CONV_3_2_EC_SIZE:0] CONV_3_2_nc_iter, CONV_3_2_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_3_2_state)
            ...
            1:begin
                ...
                conv_3_2_ons += $countones(CONV_3_2_spk_bram_wrdat_nxt);
 ...
 CONV_3_3_spk_ram (
  ...
  logic [CONV_3_3_EC_SIZE:0] CONV_3_3_nc_iter, CONV_3_3_nc_iter_nxt;
    ...
    if(rst) begin
        ...
        case(CONV_3_3_state)
            ...
            1: begin
                ...
                conv_3_3_ons += $countones(CONV_3_3_spk_bram_wrdat_nxt);
        ...
        always_ff @(posedge clk) begin
            if(rst) begin
                ...
                case(fc1_state)
                    ...
                    1:begin
                        fc1_spk_set[fc1_time_step1][fc1_neuron*USER_SET_FC_1_EC_SIZE+fc1_nc_iter] <= fc1_post_syn_spk[fc1_nc_iter];
                        fc1_spk_cntr += fc1_post_syn_spk[fc1_nc_iter];
        ...
        always_ff @(posedge clk) begin
            if (fc2_new_spk_train == 1) begin
                for (int i = 0; i < FC2_EC_SIZE; i++) begin
                    ...
                    fc2_spk_cntr += fc2_post_syn_spk[i];
                end
            end else begin
                for (int i = 0; i < FC2_EC_SIZE; i++) begin
